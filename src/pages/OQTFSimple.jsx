...
import oqtfSimpleImage from '../IMG/OQTF_30_ jours.png'
import ServicesGrid from '../components/ServicesGrid'
import FAQ2 from '../components/FAQ2'
import CallButton from '../components/CallButton'

export default function OQTFSimple() {
  return (
      ...
      <div className="hidden md:block text-white relative overflow-hidden pt-32 lg:pt-16 pb-16" style={{backgroundColor: '#12255D'}}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-16 relative z-10">
          ...
          <p className="text-lg lg:text-xl opacity-90">
            Contestez votre OQTF 30 jours avec nos experts
          </p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="pt-8 sm:pt-0 lg:pt-8 px-1 sm:px-0">
              ...
              <p className="text-base sm:text-lg mb-6 sm:mb-8 leading-relaxed" style={{color: '#1E40AF', fontFamily: 'Poppins, sans-serif'}}>
                Faire face à une Obligation de Quitter le Territoire Français (OQTF) peut être une étape difficile et source d'inquiétude. Cette décision administrative signifie que l'étranger doit quitter la France dans un délai précis. Selon la situation, il existe toutefois des <strong>recours juridiques</strong> pour contester la mesure ou demander une <strong>régularisation</strong>. Nos avocats prennent le temps d'analyser votre dossier, de vous expliquer clairement vos options et de vous assister dans toutes vos démarches pour <strong>défendre vos droits</strong>.
              </p>
