      ...
      <div className="text-white relative overflow-hidden" style={{backgroundColor: '#12255D'}}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-16 relative z-10">
          ...
          <p className="text-lg lg:text-xl opacity-90">
            Assistance juridique urgente en centre de rétention
          </p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="pt-8 sm:pt-0 lg:pt-8 px-1 sm:px-0">
              ...
              <p className="text-base sm:text-lg mb-6 sm:mb-8 leading-relaxed" style={{color: '#1E40AF', fontFamily: 'Poppins, sans-serif'}}>
                Nos avocats sont à vos côtés pour <strong>défendre vos droits</strong> et vous aider à régulariser votre situation en France. Une Obligation de Quitter le Territoire Français (OQTF) peut, dans certains cas, s'accompagner d'un Placement en Centre de Rétention Administrative (CRA), où l'étranger est retenu le temps que la mesure d'éloignement soit exécutée. Nous vous expliquons les <strong>recours possibles</strong>, les délais à respecter et les conditions permettant de contester une OQTF ou de solliciter une <strong>régularisation</strong>, tout en vous apportant un accompagnement juridique adapté à votre situation.
              </p>
            ...
            <div className="flex justify-center lg:justify-end pt-8">
              <img 
                src={oqtfPlacementImage} 
                alt="OQTF avec placement en rétention" 
