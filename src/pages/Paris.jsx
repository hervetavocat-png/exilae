          ...
          <div className="mb-16" data-aos="fade-up" data-aos-delay="200">
            <div className="bg-gradient-to-r from-red-600 to-red-700 rounded-3xl p-8 lg:p-12 text-white text-center shadow-xl">
              <h3 className="text-2xl lg:text-3xl font-bold mb-6 leading-tight" style={{fontFamily: 'Poppins, sans-serif'}}>
                Avocats en droit des étrangers au cœur de la capitale
              </h3>
              <p className="text-xl opacity-90">
                Une présence forte dans la capitale pour défendre vos droits avec détermination
              </p>
            </div>
          </div>
            ...
            <div data-aos="fade-right" data-aos-delay="400">
              <div className="relative overflow-hidden rounded-2xl shadow-lg group">
                <img 
                  ...
                  alt="Cabinet Exilae Avocats Paris" 
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Notre cabinet parisien est idéalement situé pour vous offrir un accès facile à nos services juridiques spécialisés en droit des étrangers. Nous sommes à proximité des principales institutions administratives de la capitale.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Notre équipe d'avocats parisiens possède une compétence approfondie dans la contestation des OQTF et la défense des droits des étrangers. Nous vous accompagnons avec professionnalisme et détermination.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mb-20" data-aos="fade-up" data-aos-delay="700">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg">
                Notre cabinet est situé au cœur du 16ème arrondissement de Paris
              </p>
            </div>
            ...
            <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
              <div className="grid grid-cols-1 lg:grid-cols-2">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">
                          <span className="inline-flex items-center bg-blue-600 text-white px-2 py-1 rounded-full text-sm font-bold mr-2">9</span>Station Rue de la Pompe<br />
                          <span className="inline-flex items-center bg-blue-600 text-white px-2 py-1 rounded-full text-sm font-bold mr-2">2</span>Station Victor Hugo
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">
                          Stationnement disponible sur le boulevard
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="h-96 lg:h-full min-h-[400px] relative">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2624.394!2d2.281089!3d48.871944!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e66fd98c5a81a1%3A0x7c1b4b0b7c5a81a1!2s94%20Bd%20Flandrin%2C%2075016%20Paris!5e0!3m2!1sfr!2sfr!4v1609459200000!5m2!1sfr!2sfr"
                    width="100%"
                    height="100%"
                    style={{border: 0}}
                    allowFullScreen=""
                    ...
                    title="Localisation Cabinet EXILAE Avocats Paris"
                  ></iframe>
